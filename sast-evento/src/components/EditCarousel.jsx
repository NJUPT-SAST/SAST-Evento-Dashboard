...
import { SideSheet, Button, Typography, Form, Upload, Image, Tag, Select, Avatar } from "@douyinfe/semi-ui";
import { v4 as uuidv4 } from 'uuid';

function PatchHomeSlide(props) {
    const [visible, setVisible] = useState(false)

    const list = ['https://lf3-static.bytednsdoc.com/obj/eden-cn/ptlz_zlp/ljhwZthlaukjlkulzlp/root-web-sites/dy.png',
    ...
    const renderCustomOption = (item, index) => {
        ...
        return (
            <Select.Option value={item.title} style={optionStyle} showTick={true} {...item} key={item.name}>
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Form.Input field="title" label='标题' trigger='blur' style={{ width: 200 }} initValue={props.data.title} />
