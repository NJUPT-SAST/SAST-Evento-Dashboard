...
import {
    IconHome, IconHistogram, IconLive, IconSetting, IconImage,IconClock,IconExit
            ...
            <Header style={{ backgroundColor: 'var(--semi-color-bg-1)' }}>
                <div>
                    <Nav mode="horizontal" defaultSelectedKeys={['Home']}>
                        <Nav.Header>
                            <img src={logo} alt="SAST" style={{ width: "113.12px", height: "34.32px" }} />
                        </Nav.Header>
                        <Nav.Footer>
                            <Dropdown
                                trigger={'click'}
                                ...
                                render={
                                    <Dropdown.Menu>
                                    {/* TODO: loginexit */}
                                        <Dropdown.Item onClick={()=>{}}><IconExit/> 退出登录</Dropdown.Item>
                                    </Dropdown.Menu>
                                }
                            >
